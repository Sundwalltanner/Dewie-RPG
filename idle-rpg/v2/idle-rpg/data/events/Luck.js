      ...
      switch (luckEvent) {
        ...
        case 4:
          ...
          if (updatedPlayer.gold.current < goldTaken) {
            eventMsg.push(`Carlos Matos convinced ${this.generatePlayerName(updatedPlayer, true)} to invest in Bitconnect, but as ${this.generateGenderString(updatedPlayer, 'he')} didn't have enough money, Carlos left ${this.generateGenderString(updatedPlayer, 'him')} alone.`);
            eventLog.push('Carlos Matos tried to convince you to invest in Bitconnect but you didn\'t have enough gold');
            break;
          }
          eventMsg.push(`Carlos Matos convinced ${this.generatePlayerName(updatedPlayer, true)} to invest ${goldTaken} gold in Bitconnect. That probably wasn't a wise investment.`);
          eventLog.push(`Carlos Matos convinced you to invest ${goldTaken} gold in Bitconnect. He promises this was a wise investment`);
