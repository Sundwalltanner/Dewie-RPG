...
class Monster extends BaseHelper {
  ...
  generateMonster(selectedPlayer) {
    ...
    const playerBalance = selectedPlayer.level <= 5 ? 0 : (selectedPlayer.equipment.helmet.power + selectedPlayer.equipment.bodyArmour.power + selectedPlayer.equipment.gloves.power + selectedPlayer.equipment.weapon.power + selectedPlayer.equipment.amulet.power + selectedPlayer.equipment.belt.power + selectedPlayer.equipment.ringRight.power + selectedPlayer.equipment.ringLeft.power) / 8;
