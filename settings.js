const settings = {
  ...
  guildID: process.env.GUILD_ID.includes('production')
  ...
  heartbeatTimer: process.env.NODE_ENV.includes('production') ? process.env.HEARTBEAT_TIMER : process.env.TEST_HEARTBEAT_TIMER,
